...
public class SchemaConfig implements Serializable {
    ...
    private Set<String> metaDataNodes = new HashSet<>();
    private Set<String> allDataNodes = new HashSet<>();
    /**
    ...
    private String[] allDataNodeStrArr = new String[0];
...
//		this.metaDataNodes = buildAllDataNodes();
    ...
    public String getRandomDataNode() {
        if (this.allDataNodeStrArr.length == 0) {
            return null;
        }
