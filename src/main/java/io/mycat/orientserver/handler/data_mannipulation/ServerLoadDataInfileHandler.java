...
//    private io.mycat.orientserver.OConnection OConnection;
//    private String sql;
...
//    }
//
//    public ServerLoadDataInfileHandler(OConnection OConnection) {
...
//        String charset = statement.getCharset() != null ? statement.getCharset() : OConnection.getCharset();
...
//
//        if (fileName == null) {
//            OConnection.writeErrMessage(ErrorCode.ER_FILE_NOT_FOUND, " file name is null !");
//            clear();
//            return;
//        }
//        schema = MycatServer.config
//                .getSchemas().get(OConnection.getSchema());
...
//        tempPath = SystemConfig.getHomePath() + File.separator + "temp" + File.separator + OConnection.getId() + File.separator;
...
//            //向客户端请求发送文件
//            ByteBuffer buffer = OConnection.allocate();
//            RequestFilePacket filePacket = new RequestFilePacket();
//            filePacket.fileName = fileName.getBytes();
//            filePacket.packetId = 1;
//            filePacket.write(buffer, OConnection, true);
//        } else {
//            if (!new File(fileName).exists()) {
//                OConnection.writeErrMessage(ErrorCode.ER_FILE_NOT_FOUND, fileName + " is not found!");
//                clear();
//            } else {
...
//                    OConnection.writeok();
////                    OConnection.getSession2().execute(rrs, ServerParse.LOAD_DATA_INFILE_SQL);
//                }
//
//            }
//        }
...
//        try {
//            if (sql == null) {
//                OConnection.writeErrMessage(ErrorCode.ER_UNKNOWN_COM_ERROR,
//                        "Unknown command");
//                clear();
//                return;
//            }
...
//            //走默认节点
//            RouteResultsetNode rrNode = new RouteResultsetNode(schema.getDataNode(), 1, sql);
...
////            rrs = OConnection.routeSQL(insertSql, ServerParse.INSERT);
//        }
//
//
//        if (rrs == null || rrs.getNodes() == null || rrs.getNodes().length == 0) {
...
//        rrs.setAutocommit(OConnection.isAutocommit());
