...
public class DefaultHander {
    public static void handle(MySqlStatement statement, OConnection connection) {
        MorientResponse.response(connection,statement);
    }
    public static void handlequery(MySqlStatement statement, OConnection connection) {
